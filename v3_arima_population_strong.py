# -*- coding: utf-8 -*-
"""v3_ARIMA_population_strong.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1MN5FMlHNPc-s33HfdPeG1zph1dQNs1mB
"""
...
data = pd.read_csv('baoshan.csv')

data.head()

df = data[['month', 'strong']]
...
X_train = X_train[['month', 'strong']]
X_valid = X_valid[['month', 'strong']]
X_valid.columns = ['month', 'val_strong']
X_train.columns = ['month', 'train_strong']
...
model_arima = ARIMA(X_train, order=(2,0,0))
...
chart = sns.lineplot(x='month', y='strong', data=ori_X_train)
